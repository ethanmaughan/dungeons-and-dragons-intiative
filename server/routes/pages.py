...
CLASS_THEMES = {
    "fighter": {
        ...
        "gradient": "linear-gradient(135deg, #1a2530 0%, #2e4050 50%, #1a2530 100%)",
    ...
    "wizard": {
        ...
        "gradient": "linear-gradient(135deg, #1a0a2e 0%, #382060 50%, #1a0a2e 100%)",
    ...
    "cleric": {
        ...
        "gradient": "linear-gradient(135deg, #1e1a0a 0%, #403818 50%, #1e1a0a 100%)",
        "border_style": "2px solid #e8d48a", "icon": "\u2600", "flavor": "divine",
    },
    "rogue": {
        "primary": "#d06060", "secondary": "#5a5a68", "accent": "#e89090",
        "glow": "rgba(208,96,96,0.5)", "glow_strong": "rgba(232,144,144,0.75)",
        "gradient": "linear-gradient(135deg, #0e0e14 0%, #221822 50%, #0e0e14 100%)",
    ...
    "ranger": {
        ...
        "gradient": "linear-gradient(135deg, #0a1a0a 0%, #1e381e 50%, #0a1a0a 100%)",
    ...
    "barbarian": {
        ...
        "gradient": "linear-gradient(135deg, #1a0a00 0%, #381800 50%, #1a0a00 100%)",
    ...
    "bard": {
        ...
        "gradient": "linear-gradient(135deg, #140a1e 0%, #302050 50%, #140a1e 100%)",
    ...
    "paladin": {
        ...
        "gradient": "linear-gradient(135deg, #0a141e 0%, #1a3048 50%, #0a141e 100%)",
    ...
    "druid": {
        ...
        "gradient": "linear-gradient(135deg, #0a1400 0%, #203808 50%, #0a1400 100%)",
    ...
    "monk": {
        ...
        "gradient": "linear-gradient(135deg, #141008 0%, #2c2818 50%, #141008 100%)",
    ...
    "sorcerer": {
        ...
        "gradient": "linear-gradient(135deg, #001828 0%, #003858 60%, #001828 100%)",
    ...
    "warlock": {
        ...
        "gradient": "linear-gradient(135deg, #000e08 0%, #002818 50%, #000e08 100%)",
